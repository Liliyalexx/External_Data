...
const API_KEY =
  "'api_key=live_iOZeUBHc7COor4ZnKtY09BUBgr4hkhD85REYI6lxXW0vDDKFs83MAXZ9XRIOBFyY";
...
//     // Update the info dump with breed information
//     const breedInfo = await axios.get(`breeds/${selectedBreedId}`);
//     infoDump.innerHTML = `
...
//     Carousel.start();
//   } catch (err) {
//     console.error("Error fetching breed information: ", err);
//   }
// }
/**
